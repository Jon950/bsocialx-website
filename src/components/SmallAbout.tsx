...
function SmallAbout() {
  ...
  const items = [
    ...
    {id: "3", title: "Find everthing on your home page", details: "", url: PhoneHomeView, altTag: "BsocialX home page", className: "phoneView"},
    {id: "4", title: "Find all your friends and new one", details: "", url: PhoneFriendView, altTag: "BsocialX friend finder page", className: "phoneView"}
  ];
